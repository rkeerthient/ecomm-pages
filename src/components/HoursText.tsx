        ...
        <div
          className={
            res.status.includes("Open")
              ? "text-sm font-medium  text-black Hero-hoursToday storeOpen    items-center w-max "
              : "text-sm font-medium  text-black Hero-hoursToday storeClosed    items-center w-max "
          }
        >
          <p className="">
